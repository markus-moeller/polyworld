...
objectxsortedlist LIBRARY_SHARED objectxsortedlist::gXSortedObjects;
...
void objectxsortedlist::list()
{
    ...
    gobject* pobj;
    savecurr = currItem;
    std::cout << "c" eql currItem sp "m" eql markItem sp "l" eql lastItem sp "f" eql lastItem->nextItem << " ";
    this->reset();
    std::cout << this->kount << ":";
