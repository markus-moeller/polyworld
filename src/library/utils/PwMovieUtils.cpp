...
#elif __linux__	// #elif linux
	#include <byteswap.h>
	#include <netinet/in.h>
	#include <sys/time.h>
#elif __WIN64__ || __WIN32__
    #include <winsock.h>
    #include <sys/time.h>
#endif
...
void LIBRARY_SHARED PwMovieWriter::writeFrame( uint32_t timestep,
								uint32_t width,
								uint32_t height,
								uint32_t *rgbBufOld,
								uint32_t *rgbBufNew )
...
#elif __APPLE__ /* this seems to be Apple-specific, referencing "mach"... */
