...
void glight::Print()
{
   std::cout << "For light name = " << name nl;
   std::cout << "  light dimensionality = " << dims nl;
   switch (dims)
   {
   case 1:
      std::cout << "  light position = " << pos[0] nl;
      break;
   case 2:
      std::cout << "  light position = " << pos[0] cms
                                       pos[1] nl;
      break;
   case 3:
      std::cout << "  light position = " << pos[0] cms
...
{
    std::cout << "For lighting model number " << index << "...\n";
    std::cout << "  ambient color (r,g,b) = " << ambient[0] cms
                                            ambient[1] cms
                                            ambient[2] nl;
    std::cout << "  attenuation (fixed,variable) = " << attenuation[0] cms
                                                   attenuation[1] nl;
    std::cout << "  localviewer = " << (localviewer == 1.0) nl;
}
