...
void gscene::Print()
{
    std::cout << "For the scene named \"" << fName << "\"...\n";
    if (fCamera != NULL)
    {
        std::cout << "**The camera at " << fCamera << ":" nl;
        fCamera->print();
        std::cout << "**The camera is ";
        if (!fCameraFixed)
            std::cout << "not ";
        std::cout << "fixed" nl;
    }
    else
        std::cout << "**There is no camera" nl;
    if (fStage != NULL)
    {
        std::cout << "**The stage at " << fStage << ":" nl;
        fStage->Print();
    }
    else
        std::cout << "**There is no stage" nl;
    std::cout << "**The lights in this scene will ";
    if (!fDrawLights) std::cout << "not ";
    std::cout << "be drawn" nl;
}
