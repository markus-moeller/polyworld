...
// ----------------------------------------------------------------------
// ----------------------------------------------------------------------
std::string SymbolPath::Element::getText()
{
	return token->text;
}
...
std::string SymbolPath::toString( bool leadingDecoration )
{
...
Expression::~Expression()
{
    itfor( std::list<ExpressionElement *>, elements, it )
		delete *it;
}
...
std::string Expression::toString( bool leadingDecoration )
{
...
void Expression::write( std::ostream &out, bool leadingDecoration )
{
	Token *beginToken;
	Token *endToken;
